...
Is the difference between Calvert and Montgomery significant? **Answer** They are not statistically signifigant. 
...
No counties saw their medium income fall between 2010 and 2020. 
```{r}
md10 |>
...
What political party are candidates in who are donated to the most by these zip codes? What is the most popular type of job people in these zip codes have? What county are these zip codes in? 
```{r}
md_zips_with_acs |>
