...
24 columns (variables), 13,1395 rows (observations)
...
The data type for "last_name" is character. The "amount" column is a number. I guess that the "last_name" column represents the last name of the person who donated through Win Red. The "amount" likely represets the amount of money donated by the person through Win Red.  
...
This code is grouping the number of contributions to Win Red by date. 
...
This groups the number of contributions by decending order. This allows us to clearly see what days did the most amount of contributions come in through Win Red. 
...
This adds the memo data, allowing us to see what campaign the contribution is earmarked for, and amount of each value of contribution. 
### Task 9
...
This totals the number of and amount of contributons per campaign. 
...
This included the mean and median amount of donations per campaign. The top campaign Marylanders contributed to through Win Red was the Trump reelection campaign. 
### Task 11
...
The data is now grouped by city. This allows us to understand what cities are contributing the most to Win Red. 