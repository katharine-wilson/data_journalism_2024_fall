...
**A2**
Charleston had the largest number of contributions with 3,226 contributions. 
```{r}
...
**A3**
62 cities only have one contribution.
```{r}
westvirginia_winred_contributions |>
  group_by(city) |>
  summarise(
...
The towns with only one contribution had very small populations. For example, Alum Bridge and Allen Junction have less than a few hundred people. Charleston has a population of over 47,000 people. Less people lead to fewer contributions.  
...
The Trump National Committee recived the most amount of money. Trump received 14,063 contributions, averaging $32. 
...
The top recipient is a joint fundraising committee for the Trump reelection campaign. West Virginia has voted for Trump in both Trump elections - by over 38% in 2020. The contributors are likely trying to reelect the president. 
...
West Virginians requested over $87,000 of refunds from Win Red. Big donors outweighed small donors in Moore West Virginia race. West Virginian Republicans donated most to Trump campaign, not West Virginia politicians. 
