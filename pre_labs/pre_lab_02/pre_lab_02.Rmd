...
The code is adding a column to see the percent of votes cast on election day of the total votes cast. It is also limiting the columns visible. 
...
The data was reordered by the percent of votes cast on election day (highest percentages voted on election day and down from there). 
...
This is a more interesting answer because it shows the partisan divide between people voting on election day and those embracing mail-in or early voting. Most candidates who did not get many votes on election day were Democrats. It can be more useful if doing a story about what types of voters vote early or by mail over going in-person on election day. 
...
str_to_lower makes everything lowercase and str_to_title() makes everything title case. 
...
The mutate statement is creating categories for a new table by different ranges of contributions.
```{r}
...
The largest amount of money in a category is from the less than $100 category. 
...
This is important so we can pull out this specific information every time and build upon our code instead of simplifying the code every time
...
The confusing M/D/Y format was changed to the more easy to understan YEAR-MM-DD format. 
...
The data is showing that campaigns spent the most during  June and July 2022 and the least farther away from the 2022 midterms. Most spending happened during the summer months. 