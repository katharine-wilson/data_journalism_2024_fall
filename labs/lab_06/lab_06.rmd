...
A1.54% of registered voters were Democrats in 2022 and 52% were Democrats in 2024. This was over a 1 percent decrease in overall registered Democrats. In 2024, 23% of registered voters were Republicans, a decrease from 24% in 2022. 
#For Democrats 2024 (according to "total")
(2219417/4231403)*100
```
```{r}
#For Democrats 2022 (according to "total")
(2250961/4161637)*100
```

```{r}
#Democrat percent change raw # of registered voters
((2219417 - 2250961)/2250961)*100
#Democrat percent change of proportion of registered voters
((52.45109 - 54.08836)/54.08836)*100

```

```{r}
#For Republicans 2024 (according to "total")
(1009323/4231403)*100
```
```{r}
#For Republicans 2022 (according to "total")
(998905/4161637)*100
```
