...
acs_data <- get_acs( geography = "county",  # Data for counties variables = "B19013_001",  # Median Household Income variable code year = 2021,  # Year of ACS data survey = "acs5",  # 5-year estimates output = "wide"  # Wide format (gives you 'estimate' and 'moe' columns) )

```{r}
acs_data <- get_acs(geography = "county", year = 2020)
```
